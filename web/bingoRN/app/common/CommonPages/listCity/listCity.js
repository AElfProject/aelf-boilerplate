    ...
    render() {
        return (
            <View style={{height: Dimensions.get('window').height,marginBottom:10}}>
                <View style={{flexDirection:"row", marginVertical:pTd(15), alignItems:"center"}}>
                    <Image style={{width:pTd(30), height:pTd(30), marginLeft:pTd(30), marginRight:pTd(6)}}  source={require("../../../assets/img/home/location_Icon.png")} />
                    <Text style={{fontSize:pTd(30), color:"#000"}}>当前位置：</Text>
                    <Text style={{fontSize:pTd(30), color:"#000"}}>成都市</Text>
                </View>
                <ListView
